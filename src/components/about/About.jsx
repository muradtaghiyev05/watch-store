  ...
  return (
    <div className='about-container con'>
      ...
      <div className='about-detail-container'>
        <p>Saat Dünyası 2015-ci ildən bəri Azərbaycanda fəaliyyət göstərir və uğurla öz işini davam etdirir. 
          Bu çoxillik fəaliyyətin verdiyi təcrübəyə və bu sektordakı biliyinə əsasən də Saat Dünyası öz müştərilərinə 
          tanınmış dünya istehsalçılarından orijinal məhsullar təqdim edir və hər zaman müştərilərinin məmnun qalması üçün çalışır. 
          Saat Dünyası olaraq hər daim bu sahədəki müasir trendləri və yenilikləri yaxından izləyirik və buna əsasən də, məhsullarımızın
